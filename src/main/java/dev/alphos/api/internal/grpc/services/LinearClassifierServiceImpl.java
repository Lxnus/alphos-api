...
public class LinearClassifierServiceImpl implements LinearClassifierService {

  private static final Logger logger = Logger.getLogger(LinearClassifierServiceImpl.class.getName());

  private final LinearClassifierServiceGrpc.LinearClassifierServiceBlockingStub blockingStub;

  public LinearClassifierServiceImpl(GrpcClient client) {
